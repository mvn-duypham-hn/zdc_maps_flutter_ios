...
import 'zdc_map_inspector_ios.dart';
...
class ZdcMapsFlutterIOS extends ZdcMapsFlutterPlatform {
  /// Registers the iOS implementation of GoogleMapsFlutterPlatform.
  static void registerWith() {
    ZdcMapsFlutterPlatform.instance = ZdcMapsFlutterIOS();
  }
  ...
  MethodChannel ensureChannelInitialized(int mapId) {
    ...
    if (channel == null) {
      channel = MethodChannel('vn.duypx/zdc_maps_ios_$mapId');
  ...
  Widget _buildView(
    ...
    return UiKitView(
      viewType: 'vn.duypx/zdc_maps_ios',
